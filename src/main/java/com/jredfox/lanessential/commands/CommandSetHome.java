...
import com.jredfox.lanessential.LanEssentials;
import com.jredfox.lanessential.cap.CapHome;
import com.jredfox.lanessential.cap.CapHomePoint;
import com.jredfox.lanessential.cap.Pos;
...
{	
	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException 
	{
		...
		if(args.length == 1)
		{
			if(args[0].equals(reservedHome) || args[0].equals("remove"))
				throw new WrongUsageException("home cannot be the reserved default for name \"" + args[0] + "\"",new Object[0]);
			else if(args[0].equals("count"))
				throw new WrongUsageException("/sethome count [int]",new Object[0]);
		}
