...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        if (!this.mc.gameSettings.keyBindPlayerList.isKeyDown() )//|| this.mc.isIntegratedServerRunning() && this.mc.player.connection.getPlayerInfoMap().size() <= 0 && scoreobjective1 == null)
        {
